...
#"@" is decorator
#"WSGI" represent "Web Setrvice Gateway Interface"

#"View Function" the function that can receive the request from the web and also can give response
#back to web byg using HTML content or XML
